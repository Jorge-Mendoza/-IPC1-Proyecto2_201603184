...
public class ListaAeoBus {
    ...
    public String Leer(){
        ...
        try{
          f = new File("C:\\Users\\jorgi\\Desktop\\ArchivosCSVPrueba - copia\\01 AerolineasBuses.csv");
          fr=new FileReader(f);
    ...
    public AeroLineaBus Ver(String a){
        
        AeroLineaBus obj=new AeroLineaBus();
        String cadena[]=a.split(",");
        obj.codTrans=Integer.parseInt(cadena[0]);
        obj.salida=cadena[1];
        obj.llegada=cadena[2];
        obj.capacidad=Integer.parseInt(cadena[3]);
        obj.codDestino=Integer.parseInt(cadena[4]);
    ...
    public void Enlistar(AeroLineaBus e){
    ...
    AeroLineaBus primero;
    public ListaAeoBus(){
        primero=new AeroLineaBus();
    }
