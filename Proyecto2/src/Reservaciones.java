...
public class Reservaciones extends javax.swing.JFrame {
    ...
    public void recorre(){
        ListaPaquetes obj=new ListaPaquetes();
        obj.Correr();
        obj.recorre();
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        a.Correr();
        Buscar(Integer.parseInt(jTextField1.getText()));
    ...
    public void Buscar(int i){
        ...
        jTextField2.setText(aux.nombres+" "+aux.apellidos);
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null,"No se ha encontrado ningún cliente, porfavor ingrese al cliente");
